    ...
    <>
      ...
      <div className="w-2/3 pl-4 flex flex-col">
        ...
        <div className="grid grid-cols-4 gap-2">
          ...
          <button className="bg-green-500 text-white p-3 rounded-full">ON</button>
          <button className="bg-red-500 text-white p-3 rounded-full">OFF</button>
          <button className="bg-yellow-400 text-black p-3 rounded-full">▶</button>
        </div>
      </div>
    </div>
    </>
